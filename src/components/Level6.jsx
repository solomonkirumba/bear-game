...
import { level6data, ansresult, questions } from "../data/gamedata";

function Level6({ advance, gameHealth }) {
  ...
  return (
    <div className="game-container">
      <div className="level-indicator">Level 6</div>
      
      <div className="question-container">
        <h2 className="question-text">{questions.level6}</h2>
        <p className="question-hint">This might be your only chance!</p>
      </div>
  ...
  if (answerstate === ansresult[1]) {
    return (
      <div className="result-container">
        <h3 className="result-title">Found It! 🚪</h3>
        <p className="result-text">{level6data.outcome2}</p>
    ...
    return (
      <div className="result-container">
        <h3 className="result-title">Another Way? 🤔</h3>
        <p className="result-text">{level6data.outcome2_alt}</p>
    ...
    return (
      <div className="result-container game-over">
        <h3 className="result-title">Too Clumsy! 💀</h3>
        <p className="result-text">{level6data.outcome1}</p>
