...
import { level4data, ansresult, questions } from "../data/gamedata";

function Level4({ advance, gameHealth }) {
  ...
  return (
    <div className="game-container">
      <div className="level-indicator">Level 4</div>
      
      <div className="question-container">
        <h2 className="question-text">{questions.level4}</h2>
        <p className="question-hint">Don't panic! Think carefully...</p>
      </div>
  ...
  if (answerstate === ansresult[1]) {
    return (
      <div className="result-container">
        <h3 className="result-title">Smart Move! 🔑</h3>
        <p className="result-text">{level4data.outcome2}</p>
    ...
    return (
      <div className="result-container">
        <h3 className="result-title">He's Watching... 👁️</h3>
        <p className="result-text">{level4data.outcome2_alt}</p>
