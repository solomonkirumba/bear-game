...
import { level8data, ansresult, questions } from "../data/gamedata";

function Level8({ advance, gameHealth }) {
  ...
  return (
    <div className="game-container">
      <div className="level-indicator">Level 8</div>
      
      <div className="question-container">
        <h2 className="question-text">{questions.level8}</h2>
        <p className="question-hint">Complete darkness... choose wisely</p>
      </div>
      ...
      <div className="answer-grid">
        ...
        <button 
          onClick={() => handleAnswerClick(ansresult[1], "button4")}
  ...
  if (answerstate === ansresult[1]) {
    return (
      <div className="result-container">
        <h3 className="result-title">Light in Darkness! 🔦</h3>
        <p className="result-text">{level8data.outcome1 || level8data.outcome1_alt}</p>
    ...
    return (
      <div className="result-container">
        <h3 className="result-title">Stumbled but Found It! 👣</h3>
        <p className="result-text">{level8data.outcome2}</p>
    ...
    return (
      <div className="result-container game-over">
        <h3 className="result-title">He Found You! 💀</h3>
        <p className="result-text">{level8data.outcome3}</p>
